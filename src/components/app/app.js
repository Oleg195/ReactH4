...
class App extends Component {
  constructor(props){
    ...
    this.state={
      data: [
        {name: 'Мышка',salary: 800,rise:true, increase: false,id:1},
        {name: 'Клавиатура',salary: 3000,rise:false, increase: true,id:2},
        {name: 'Монитор',salary: 5000,rise:false, increase: false,id:3}
      ],
      term:'',
      filter:"all"
